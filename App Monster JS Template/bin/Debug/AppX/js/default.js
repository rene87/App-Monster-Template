...
(function () {
    ...
    function createAppMonster() {
        ...
        Windows.Storage.StorageFile.getFileFromApplicationUriAsync(imageUri).then(function (imageFile) {
            ...
            myAppMonster = new AppMonsters.AppMonster(appMonsterName, appMonsterDefaultDescription, firstAttack, secondAttack, defense, hitpoints, heal, paid, imageFile, imageUri);
